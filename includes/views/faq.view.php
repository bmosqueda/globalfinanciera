  ...
  <div class="columns is-centered">
    ...
    <div class="column is-8-desktop is-10-tablet is-12-mobile">
      <!-- Collapsible -->
        <div class="collapsible card is-fullwidth is-shadowless">
          ...
          <div class="card-content is-paddingless is-hidden">
            <div class="content">
              INE, comprobante de domicilio, comprobante de ingresos, dos referencias personales con nombre completo y
              tel&eacute;fono.
            </div>
          </div>
        </div>
      ...
      <div class="question">
        ...
        <p>INE, comprobante de domicilio, comprobante de ingresos, dos referencias personales con nombre completo y
          tel&eacute;fono.</p>
      </div>
      <!-- Collapsible -->
        <div class="collapsible card is-fullwidth is-shadowless">
          ...
          <div class="card-content is-paddingless is-hidden">
            <div class="content">
              No hay inconveniente, puede enviar la documentaci&oacute;n anterioriormente mencionada.
            </div>
          </div>
        </div>
      <!-- /Collapsible -->
      <div class="question">
        ...
        <p>No hay inconveniente, puede enviar la documentaci&oacute;n anterioriormente mencionada.</p>
      </div>
      <!-- Collapsible -->
        <div class="collapsible card is-fullwidth is-shadowless">
          <header class="card-toggle card-header is-shadowless">
          ...
          <div class="card-content is-paddingless is-hidden">
            <div class="content">
              No es determinante el bur&oacute; de cr&eacute;dito.
            </div>
          </div>
        </div>
      <!-- /Collapsible -->
      <div class="question">
        ...
        <p>No es determinante el bur&oacute; de cr&eacute;dito.</p>
      </div>
      <hr>
    </div>
  </div>
  <div class="columns is-centered">
    ...
    <div class="column is-8-desktop is-10-tablet is-12-mobile">
      ...
      <div class="question">
        ...
        <p>Desde $20,000 hasta $2,000,000.</p>
      </div>
      <!-- Collapsible -->
        <div class="collapsible card is-fullwidth is-shadowless">
          <header class="card-toggle card-header is-shadowless">
      ...
      <div class="question">
        ...
        <p>Por medio de una transferencia bancaria.</p>
      </div>
      <!-- Collapsible -->
        <div class="collapsible card is-fullwidth is-shadowless">
          <header class="card-toggle card-header is-shadowless">
          ...
          <div class="card-content is-paddingless is-hidden">
            <div class="content">
              Los pr&eacute;stamos son personal y empresariales.
            </div>
          </div>
        </div>
      <!-- /Collapsible -->
      <div class="question">
        ...
        <p>Los pr&eacute;stamos son personal y empresariales.</p>
      </div>
      <hr>
    </div>
  </div>
    ...
    <div class="column is-8-desktop is-10-tablet is-12-mobile">
      ...
      <!-- Collapsible -->
        <div class="collapsible card is-fullwidth is-shadowless">
          ...
          <div class="card-content is-paddingless is-hidden">
            <div class="content">
              El tr&aacute;mite dura máximo 5 días, dependiendo la demora del cliente.
            </div>
          </div>
        </div>
      <!-- /Collapsible -->
      <div class="question">
        ...
        <p>El tr&aacute;mite dura máximo 5 días, dependiendo la demora del cliente.</p>
      </div>
      <hr>
    </div>
  </div>
  <div class="columns is-centered">
    ...
    <div class="column is-8-desktop is-10-tablet is-12-mobile">
      ...
      <div class="question">
        ...
        <p>Abarcamos toda la república mexicana.</p>
      </div>
      <!-- Collapsible -->
        <div class="collapsible card is-fullwidth is-shadowless">
          <header class="card-toggle card-header is-shadowless">
          ...
          <div class="card-content is-paddingless is-hidden">
            <div class="content">
              Siempre y cuando tengan residencia en M&eacute;xico.
            </div>
          </div>
        </div>
      <!-- /Collapsible -->
      <div class="question">
        ...
        <p>Siempre y cuando tengan residencia en M&eacute;xico.</p>
      </div>
      <hr>
    </div>
  </div>
