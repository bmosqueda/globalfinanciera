    ...
    <div class="column is-8-desktop is-10-tablet is-12-mobile">
      ...
      <!-- Collapsible -->
        <div class="collapsible card is-fullwidth is-shadowless">
          ...
          <div class="card-content is-paddingless is-hidden">
            <div class="content">
              No hay inconveniente, se puede realizar el trámite con los dem&aacute;s documentos.
            </div>
          </div>
        </div>
      <!-- /Collapsible -->
      <div class="question">
        ...
        <p>No hay inconveniente, se puede realizar el trámite con los dem&aacute;s documentos.</p>
      </div>
      <!-- Collapsible -->
        <div class="collapsible card is-fullwidth is-shadowless">
          <header class="card-toggle card-header is-shadowless">
          ...
          <div class="card-content is-paddingless is-hidden">
            <div class="content">
              No, ya que no es determinante para otorgarle el crédito
            </div>
          </div>
        </div>
      <!-- /Collapsible -->
      <div class="question">
        ...
        <p>No, ya que no es determinante para otorgarle el crédito</p>
      </div>
      <hr>
    </div>
  </div>
      ...
      <div class="column is-8-desktop is-10-tablet is-12-mobile">
        ...
        <!-- Collapsible -->
          <div class="collapsible card is-fullwidth is-shadowless">
            ...
            <div class="card-content is-paddingless is-hidden">
              <div class="content">
                El tr&aacute;mite dura máximo 5 días, dependiendo la respuesta del cliente.
              </div>
            </div>
          </div>
        <!-- /Collapsible -->
        <div class="question">
          ...
          <p>El tr&aacute;mite dura máximo 5 días, dependiendo la respuesta del cliente.</p>
        </div>
        <hr>
      </div>
    </div>
